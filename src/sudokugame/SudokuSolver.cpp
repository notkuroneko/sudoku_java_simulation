...
// 60: mở sudokuSolve.py
// 84: nếu biết trc Jupyter và Python thì viết ngắn hơn nhiều <("). ye the main course
#define SIZE 9
...
bool Solver::backtrack(int row, int col) {
    // yea hàng 9 cột 10 aka hết bảng. đi hết thì true
    ...
    /*
    gần giống sudokuGen.cpp ở đoạn dùng sysClock

    nhưng thay vì các số  điền trc thì đây đúng là ngẫu nhiên. để ý chữ seed

    human rights lost: https://cplusplus.com/forum/beginner/251751/
    */
